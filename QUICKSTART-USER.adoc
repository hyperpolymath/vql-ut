...
// Replace vql-ut, Vql Ut — See README.adoc for details., just run, Vql Ut started successfully. with actuals
= vql-ut — Quick Start for Users
:toc:
:toclevels: 2

== What is vql-ut?

Vql Ut — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./vql-ut-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/vql-ut/wiki
